...
- You can go back to an existing screen in the stack with `navigation.goBack()`, and you can go back to the first screen in the stack with `navigation.popToTop()`.
